...
TOTAL_VEG = 1.5 # the total LAI and SAI values together (m^2 per m^2)
STORAGE_MAX = 100.0/1000 # max storage of the growing medium in dpeth (m)
...
k = (0.002/60)*DT # the green roof model uses a non-linear formula. K is the multiplier before then
...
for i in range(0,384):
	...
	SMCDRY = 0.2 # M3 per M3
	SMCREF = 0.36 # M3 per M3
